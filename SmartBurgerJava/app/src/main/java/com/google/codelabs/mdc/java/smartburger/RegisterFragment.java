...
public class RegisterFragment extends Fragment {
            ...
            public void onClick(View view) {
                ...
                if (conexionInternet()) {
                    if (camposValidos(namePlaceHolder, lastnamePlaceHolder, emailPlaceHolder, passwordPlaceHolder, dniPlaceHolder, commissionPlaceHolder, groupPlaceHolder,
                        ...
                        User datosRegistro = cargarDatosRegistro(name, lastname, dni, email, password, commission, group);
    ...
    public User cargarDatosRegistro(String name, String lastname, Integer dni, String email, String password,
                                        Integer commission, Integer group) {
        User datosRegistro = new User();
