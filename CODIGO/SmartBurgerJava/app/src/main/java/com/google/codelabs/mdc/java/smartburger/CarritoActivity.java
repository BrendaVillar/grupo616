   ...
   private ArrayList<String> ingredientes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cantPasos<10000){
            ...
            alertaPasos.setText("El contador de pasos de tu celu dice que hoy hiciste menos de 10000 pasos ¡Por tu salud deberias caminar mas para comer esta hamburguesa!");
